...
import '../../ThaiBaht.dart';
import '../../loadAndCacheImage.dart';
              ...
              children: [
                ...
                pw.Container(
                  child: labeledLine1(
                    flex: 1,
                    value:
                        jsonDecode(contractPhotoModels[0].sub_cid)['service'] ??
                            '',
                    font: ttf,
                  ),
                ),
                ...
                pw.Container(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      Textx(
                        value:
                            'บริษัท นิ่มซิตี้ เดลี่ จำกัด โดยดร.ปราณี สุวิทย์ศักดานนท์ และนายชวลิต สุวิทย์ศักดานนท์ กรรมการซึ่งลง',
                        font: ttf,
                      ),
                      Textx(
                        value:
                            'ชื่อผูกพันบริษัทฯได้ สำนักงานแห่งใหญ่ตั้งอยู่ที่เลขที่ 197,199/8-9 ถนนมหิดล ตำบลหายยา อำเภอเมือง',
                        font: ttf,
                      ),
                      Textx(
                        value:
                            'เชียงใหม่  จังหวัดเชียงใหม่ 50100 ทะเบียน นิติบุคคล  เลขที่ 0-5055-55010-14-7  ซึ่งต่อไปในสัญญานี้',
                        font: ttf,
                      ),
                      Textx(
                        value: 'เรียกว่า ‘‘ผู้ให้บริการ’’ ฝ่ายหนึ่ง กับ',
                        font: ttf,
                      ),
                    ],
                  ),
            ...
            pw.Column(children: [
              pw.Row(children: [
                ...
                labeledLine1(
                    flex: 1,
                    value:
                        jsonDecode(contractPhotoModels[0].sub_cid)['lease'] ??
                            '',
                    font: ttf),
              ]),
              pw.Row(children: [
