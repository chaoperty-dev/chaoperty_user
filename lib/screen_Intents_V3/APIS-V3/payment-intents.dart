...
Future<http.Response?> postPaymentIntents(
  ...
  try {
    ...
    final headers = await MyHeadersIntents.build();
    final url = Uri.parse('http://192.168.1.89:3004/api/v1/payment/intent');
    ...
    final body = {
      "payloads": {
        ...
        "receiving_account": "", // ✅ Required field by API
...
Future<http.Response?> postGeneratePaymentIntents({
  ...
  try {
    ...
    final headers = await MyHeadersIntents.build();
    final url = Uri.parse(
        'http://192.168.1.89:3004/api/v1/payment/intent/${intentsUuid}/generate');
...
Future<http.Response?> getDetailsPaymentIntents({
  ...
  try {
    final headers = await MyHeadersIntents.build();
    final url = Uri.parse(
        'http://192.168.1.89:3004/api/v1/payment/intent/${intentsUuid}');
...
Future<http.Response?> getSlipPreviewPaymentIntents({
  ...
  try {
    final headers = await MyHeadersIntents.build();
    final url = Uri.parse(
        'http://192.168.1.89:3004/api/v1/payment/intent/upload/${slipUuid}/preview');
