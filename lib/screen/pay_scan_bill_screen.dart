...
class PayScanBillscreen extends StatefulWidget {
  ...
  // : super(key: key);
  @override
  State<PayScanBillscreen> createState() => _PayScanBillscreenState();
}

class _PayScanBillscreenState extends State<PayScanBillscreen> {
  ...
  void initState() {
    ...
    read_GC_fine();
    // red_Trans_bill().then((value) {
    //   for (int index = 0; index < _TransBillModels.length; index++) {
    //     if (_TransBillModels[index].invoice == null) {
  ...
  Future<Null> red_Invoice() async {
    ...
    SharedPreferences preferences = await SharedPreferences.getInstance();
    var ren = preferences.getString('renTalSer');
    var ciddoc_ = widget.barcode;
    var qutser_ = preferences.getString('qutser');
    ////////////////------------------------------------------------------>

    String url =
        '${MyConstant().domain_chao}/GC_bill_invoice_barcode.php?isAdd=true&ren=$ren&ciddoc=$ciddoc_&qutser=$qutser_';
    try {
      var response = await http.get(Uri.parse(url));
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(20),
                        border:
                            Border.all(color: grey, style: BorderStyle.solid),
                        color: Colors.white,
                      ),
                      child: Column(
                        children: [
                            ...
                            children: [
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Text(
                                    '${(_TransBillModels.length + invoicePayModels.length)} รายการ',
                                    style: TextStyle(
                                      fontSize: 16,
                                  ...
                                  child: Text(
                                    _TransModels.length != 0
                                        ? invoicePayModels.length != 0
                                            ? '${nFormat.format((_TransModels.map((e) => double.parse(e.total.toString())).reduce((a, b) => a + b)) + (invoicePayModels.map((e) => double.parse(e.amtall.toString())).reduce((a, b) => a + b)))}'
                                            : '${nFormat.format((_TransModels.map((e) => double.parse(e.total.toString())).reduce((a, b) => a + b)))}'
                                        : invoicePayModels.length != 0
                                            ? '${nFormat.format((invoicePayModels.map((e) => double.parse(e.amtall.toString())).reduce((a, b) => a + b)))}'
                                            : '0.00',
                                    textAlign: TextAlign.end,
                                    style: TextStyle(
                                      fontSize: 14,
                ...
                (tap == 0)
                    ...
                    : Padding(
                        ...
                        child: Container(
                            ...
                            child: _TransBillModels.length == 0 &&
                                                  ...
                                                  child: ListTile(
                                                    ...
                                                    title: Row(
                                                      children: [
                                                        Expanded(
                                                          child: Text(
                                                            '${(index_in + 1)}. ${_InvoiceModels[index_in].descr}',
                                                            textAlign:
                                                                TextAlign.start,
                                                            style: const TextStyle(
                                                                fontSize: 14,
                                                        ...
                                                        Expanded(
                                                          child: Text(
                                                            '${nFormat.format(double.parse(_InvoiceModels[index_in].amtall.toString()))}',
                                                            textAlign:
                                                                TextAlign.end,
                                                            style: TextStyle(
                                                              fontSize: 14,
                                                    ...
                                                    subtitle: Row(children: [
                                                      ...
                                                      Text(
                                                        '${DateFormat('dd-MM').format(DateTime.parse('${_InvoiceModels[index_in].date}'))}-${int.parse('${DateFormat('yyyy').format(DateTime.parse('${_InvoiceModels[index_in].date}'))}') + 543}',
                                                        style: const TextStyle(
                                                          fontFamily:
                                                              Font_.Fonts_T,
                                                        ),
                                                    ...
                                                    trailing: IconButton(
                                                      onPressed: () {
                                                        if (invoicePayModels
                                                          ...
                                                          setState(() {
                                                            ...
                                                            sum_disamt_in =
                                                                sum_disamt_in -
                                                                    fine_dis;
                                                            sum_vat_in = sum_vat_in -
                                                                double.parse(
                                                                    _InvoiceModels[
                                                                            index_in]
                                                                        .vat!);
                                                            sum_wht_in = sum_wht_in -
                                                                double.parse(
                                                                    _InvoiceModels[
                                                                            index_in]
                                                                        .wht!);
                                                            sum_pvat_in = sum_pvat_in -
                                                                double.parse(
                                                                    _InvoiceModels[
                                                                            index_in]
                                                                        .amtall!) -
                                                        ...
                                                        print(
                                                            '${invoicePayModels.map((e) => '${e.ser}> ${e.docno}> ${e.fine}> ${e.discount}')}');
                                                        // var ind =
                                                        //     invoicePayModels
                                                        //         .elementAtOrNull(
                                                        //             index_in)!
                                                  ...
                                                  child: ListTile(
                                                    ...
                                                    trailing: IconButton(
                                                      ...
                                                      icon:
                                                          ...
                                                          //     .check_circle_outline)
                                                          Icon(
                                                        _TransBillstring.elementAtOrNull(
                                                                        index)!
                                                                    .docno
                                                                    .toString() ==
                                                                _TransBillModels[
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              child: AutoSizeText(
                                ...
                                maxFontSize: 15,
                                textAlign: TextAlign.end,
                                '${nFormat.format((sum_pvat + sum_tran_fine) - (sum_disamt + sum_disamt_in) + (sum_pvat_in + sum_tran_fine_in))}',
                                style: const TextStyle(
                                    color: Colors.black,
                                    //fontWeight: FontWeight.bold,
                                    fontFamily: Font_.Fonts_T),
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              child: AutoSizeText(
                                ...
                                maxFontSize: 20,
                                textAlign: TextAlign.end,
                                '${nFormat.format(sum_pvat + sum_tran_fine - dis_sum_Pakan - (sum_disamt + sum_disamt_in) + (sum_pvat_in + sum_tran_fine_in) + (fine_total))}',
                                style: const TextStyle(
                                    color: Colors.black,
                                    //fontWeight: FontWeight.bold,
                                    fontFamily: FontWeight_.Fonts_T),
                        ...
                        Row(
                          children: [
                            Expanded(
                                child: Text(
                              paymentName1 == null ? '' : "$paymentName1",
                              style: TextStyle(
                                fontFamily: Font_.Fonts_T,
                                // fontWeight: FontWeight.bold,
                              ),
                              ...
                              child: Container(
                                ...
                                child: ElevatedButton(
                                  onPressed: () async {
                                    ...
                                    if (double.parse(Form_payment1.text) !=
                                            0.00 &&
                                        double.parse(Form_payment1.text) != 0) {
                                      setState(() {
                                        if (select_pay == 1) {
                                          select_pay = 0;
                                        } else {
                              ...
                              for (int index = 0;
                                ...
                                ListTile(
                                  ...
                                  subtitle: Row(children: [
                                    Expanded(
                                      child: Text(
                                        _PayMentModels[index].fine.toString() ==
                                                '0'
                                            ? 'ฟรีค่าธรรมเนียม'
                                        ...
                                        setState(() {
                                          _scrollController.animateTo(
                                              ...
                                              duration: const Duration(
                                                  milliseconds: 500));
                                          fine_total =
                                              _PayMentModels[index].fine == '1'
                                                  ? fine_amt
                                                  : 0.00;
                                          select_pay = 0;
                                          paymentName1 =
                                              _PayMentModels[index].ptname;
                                          selectedValue = _PayMentModels[index]
                                              .bno
                                              .toString();
                                          paymentSer1 = _PayMentModels[index]
                                              .ser
                                              .toString();

                                          payment_tser = _PayMentModels[index]
                                              .ptser
                                              .toString();
                                          payment_co = _PayMentModels[index]
                                              .co
                                              .toString();

                                          payment_bname = _PayMentModels[index]
                                              .bname
                                              .toString();
                                          payment_bank = _PayMentModels[index]
                                              .bank
                                              .toString();
                                            ...
                                            : () async {
                                                ...
                                                try {
                                                  ...
                                                  _showMyDialogPay_Error(
                                                      'เกิดข้อผิดพลาด ตรวจสอบความถูกต้อง กรุณาลองอีกครั้ง!01');
                                                }
                                              },
                                        style: ButtonStyle(
                                            shape: MaterialStateProperty.all<
