...
import '../../../main.dart';
import '../../../screen_Intents/payment_mainV2_InvAll.dart';
...
class _TrainingPayScreenState extends State<TrainingPayScreen>
  ...
  void addAllListData() {
    ...
    //     animationController: _effectiveController,
    //   ),
    // );
              ...
              mainScreenAnimation: Tween<double>(begin: 0.0, end: 1.0).animate(
                  CurvedAnimation(
                      ...
                      curve: Interval((1 / count) * 5, 1.0,
                          curve: Curves.fastOutSlowIn))),
              mainScreenAnimationController: _effectiveController,
              teNantModel: teNantModels,
              cuslang: cus_lang,
            )
