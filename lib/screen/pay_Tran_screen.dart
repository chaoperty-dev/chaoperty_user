...
class PayTranscreen extends StatefulWidget {
  // final List item;
  // final List InvoiceHistoryModels;
  PayTranscreen({super.key});
  // Payscreen({Key? key, required this.item, required this.InvoiceHistoryModels})
  // : super(key: key);
  @override
  State<PayTranscreen> createState() => _PayTranscreenState();
}

class _PayTranscreenState extends State<PayTranscreen> {
